...
function NEVERWIN:Window(WindowNameString,Title_str,cinfisize)
...
function WindowFunctinos:EditOpenButton(config)
	...
	function WindowFunctinos:TabLabel(NAME)
	...
	function WindowFunctinos:Tab(TAB_NAME,icon)
		...
		function TabAssets:Section(SectionNameString,int)
			int=int or 'left'
			...
			function sectionasaste:Label(LabelName)
			...
			function sectionasaste:Slider(SliderNameString,Min,Max,Default,callback)
				Min=Min or 1
				Max=Max or 100
			...
			function sectionasaste:Button(ButtonNamestr,callback)
				callback=callback or function()

...
do
    ...
    function a.c()
        ...
        local c, d, e, f, g = b.Heartbeat, game:GetService'UserInputService', game:GetService'TweenService', a.load'b', {
        ...
        function g.Icon(h)
            if f.Icons[h] then
                return {
                    f.Spritesheets[tostring(f.Icons[h].Image)],
                    f.Icons[h],
                }
            end
        ...
        function g.Drag(h)
            ...
            local o = function(o)
                if g.CanDraggable then
                    ...
                    g.Tween(h, 0.08, {
                        Position = UDim2.new(n.X.Scale, n.X.Offset + p.X, n.Y.Scale, n.Y.Offset + p.Y),
                    }):Play()
                end
            end

            h.InputBegan:Connect(function(p)
            ...
            h.InputChanged:Connect(function(p)
    ...
    function a.e()
        ...
        return function(e)
            local f = {
                ...
                Hover = e.Hover,
                Image = e.Image,
                ImageSize = e.ImageSize or 30,
                UIPadding = 12,
                UIElements = {},
            }
            local g, h, i = f.ImageSize, true

            if f.Image then
                local j = c('ImageLabel', {
                    Size = UDim2.new(1, 0, 1, 0),
                    BackgroundTransparency = 1,
                    ThemeTag = b.Icon(f.Image) and {
                        ImageColor3 = 'Text',
                    } or nil,
                }, {
                    c('UICorner', {
                ...
                if b.Icon(f.Image) then
                    j.Image = b.Icon(f.Image)[1]
                    j.ImageRectOffset = b.Icon(f.Image)[2].ImageRectPosition
                    j.ImageRectSize = b.Icon(f.Image)[2].ImageRectSize
                end
                if string.find(f.Image, 'http') then
                    if not isfile('WindUI' .. e.Window.Folder .. '/Assets/' .. f.Title .. '.png') then
                        local k = request{
                            Url = f.Image,
                            Method = 'GET',
                        }.Body

                        writefile('WindUI' .. e.Window.Folder .. '/Assets/' .. f.Title .. '.png', k)
                    end

                    j.Image = getcustomasset('WindUI' .. e.Window.Folder .. '/Assets/' .. f.Title .. '.png')
                elseif string.find(f.Image, 'rbxassetid') then
                    j.Image = f.Image
                end
            end
            ...
            f.UIElements.Main = c('TextButton', {
                ...
                i,
                c('Frame', {
                    Size = UDim2.new(1, f.Image and -(g + f.UIPadding), 0, 0),
                    AutomaticSize = 'Y',
                    AnchorPoint = Vector2.new(0, 0),
                    Position = UDim2.new(0, f.Image and g + f.UIPadding or 0, 0, 0),
                    BackgroundTransparency = 1,
                    Name = 'Title',
                }, {
                    c('UIListLayout', {
            ...
            if f.Desc then
                ...
                f.UIElements.Main.Title.Size = UDim2.new(1, f.Image and -(g + f.UIPadding), 0, 0)
                f.UIElements.Main.Title.Position = UDim2.new(0, f.Image and g + f.UIPadding or 0, e.IsButtons and 0 or 0.5, 0)
            end
            if f.Hover then
            ...
            function f.SetTitle(k, n)
                f.UIElements.Main.Title.Title.Text = n
            end
            function f.SetDesc(k, n)
                if j then
                    j.Text = n
                else
                    j = c('TextLabel', {
            ...
            function f.Lock(k)
                d(f.UIElements.Main.Lock, 0.08, {BackgroundTransparency = 0.6}):Play()
                d(f.UIElements.Main.Lock.ImageLabel, 0.08, {ImageTransparency = 0}):Play()

                f.UIElements.Main.Lock.Active = true
                h = false
            end
            function f.Unlock(k)
                d(f.UIElements.Main.Lock, 0.08, {BackgroundTransparency = 1}):Play()
                d(f.UIElements.Main.Lock.ImageLabel, 0.08, {ImageTransparency = 1}):Play()
    ...
    function a.h()
        ...
        function d.New(f, g)
            ...
            local o, p, q = n, (n - (h.Value.Min or 0)) / ((h.Value.Max or 100) - (h.Value.Min or 0)), true
            ...
            function h.Set(r, s, t)
                if q then
                    if not h.IsFocusing and not e and (not t or (t.UserInputType == Enum.UserInputType.MouseButton1 or t.UserInputType == Enum.UserInputType.Touch)) then
                        s = math.clamp(s, h.Value.Min or 0, h.Value.Max or 100)

                        local u = math.clamp((s - (h.Value.Min or 0)) / ((h.Value.Max or 100) - (h.Value.Min or 0)), 0, 1)

                        s = math.floor((h.Value.Min + u * (h.Value.Max - h.Value.Min)) / h.Step + 0.5) * h.Step

                        if s ~= o then
                            h.UIElements.SliderIcon.Frame.Size = UDim2.new(u, 0, 1, 0)
                            h.UIElements.SliderContainer.TextBox.Text = tostring(s)
                            o = s
                        ...
                        if t then
                            ...
                            j = game:GetService'RunService'.RenderStepped:Connect(function()
                                local v = i and t.Position.X or game:GetService'UserInputService':GetMouseLocation().X
                                local w = math.clamp((v - h.UIElements.SliderIcon.AbsolutePosition.X) / h.UIElements.SliderIcon.Size.X.Offset, 0, 1)

                                s = math.floor((h.Value.Min + w * (h.Value.Max - h.Value.Min)) / h.Step + 0.5) * h.Step

                                if s ~= o then
                                    h.UIElements.SliderIcon.Frame.Size = UDim2.new(w, 0, 1, 0)
                                    h.UIElements.SliderContainer.TextBox.Text = tostring(s)
                                    o = s
                            ...
                            k = game:GetService'UserInputService'.InputEnded:Connect(function(v)
            ...
            h.UIElements.SliderContainer.TextBox.FocusLost:Connect(function(r)
                if r then
                    local s = tonumber(h.UIElements.SliderContainer.TextBox.Text)

                    if s then
                        h:Set(s)
                    else
                        h.UIElements.SliderContainer.TextBox.Text = tostring(o)
                    end
                end
            end)
    ...
    function a.i()
        local b, c = game:GetService'UserInputService', a.load'c'
    ...
    function a.k()
        local b, c, d, e = game:GetService'UserInputService', game:GetService'Players'.LocalPlayer:GetMouse(), game:GetService'Workspace'.CurrentCamera, a.load'c'
        ...
        function h.New(i, j)
            ...
            function k.Open(q)
                ...
                g(k.UIElements.Dropdown.ImageLabel, 0.15, {Rotation = 180}):Play()
                UpdatePosition()
            end
            function k.Close(q)
                k.Opened = false
                ...
                g(k.UIElements.Dropdown.ImageLabel, 0.15, {Rotation = 0}):Play()
                task.wait(0.1)
    ...
    function a.m()
        ...
        function e.New(f, g)
            ...
            n.FontFace = Font.new('rbxassetid://16658246179', Enum.FontWeight.Medium)
            ...
            k.MouseButton1Click:Connect(function()
                if i then
                    toclipboard(h.Code)
                    g.WindUI:Notify{
                        Title = '\u{590d}\u{5236}\u{6210}\u{529f}!',
                        Content = "\u{6587}\u{4ef6}'" .. h.Title .. "' \u{5df2}\u{7ecf}\u{6210}\u{529f}\u{590d}\u{5236}\u{5230}\u{60a8}\u{7684}\u{7c98}\u{8d34}\u{677f}\u{91cc}",
                        Icon = 'clipboard-copy',
                        Duration = 5,
                    }
                end
        ...
        function e.Create(f)
            ...
            function g.Open(h)
                ...
                task.spawn(function()
                    ...
                    d(g.UIElements.Main.UIStroke, 0.1, {Transparency = 0.8}):Play()
                end)
            end
            function g.Close(h)
                if not f then
                ...
                d(g.UIElements.Main.UIScale, 0.1, {Scale = 0.9}):Play()
    ...
    function a.o()
        ...
        function n.Colorpicker(o, p, q)
            ...
            local s = a.load'n'.Init(p.Window)
            local t = s.Create()
            ...
            r.UIElements.Title = c('TextLabel', {
                Text = '\u{63d0}\u{53d6}\u{989c}\u{8272}',
                TextSize = 20,
                FontFace = Font.new(b.Font, Enum.FontWeight.SemiBold),
                TextXAlignment = 'Left',
                Size = UDim2.new(1, 0, 0, 0),
            ...
            r.UIElements.Inputs = c('Frame', {
                AutomaticSize = 'XY',
                Position = UDim2.fromOffset(r.Transparency and 230 or 200, 40),
                BackgroundTransparency = 1,
                Parent = t.UIElements.Main,
            }, {
                c('UIListLayout', {
            ...
            end, CreateInput('\u{5341}\u{516d}\u{8fdb}\u{5236}', '#' .. r.Default:ToHex())
            local J, K, L, M = CreateInput('\u{7ea2}', H(r.Default).R), CreateInput('\u{7eff}', H(r.Default).G), (CreateInput('\u{84dd}', H(r.Default).B))
            ...
            for P, Q in next, O do
                local R = c('TextButton', {
                    ...
                    ZIndex = 999999,
                    Parent = N,
                    Size = UDim2.new(1 / #O, -(((#O - 1) * 8) / #O), 0, 0),
                    AutomaticSize = 'Y',
                }, {
                    c('UICorner', {
                        CornerRadius = UDim.new(0, t.UICorner - 7),
                    }),
                    c('UIPadding', {
                        PaddingTop = UDim.new(0, t.UIPadding / 1.6),
                        PaddingLeft = UDim.new(0, t.UIPadding / 1.6),
                        PaddingRight = UDim.new(0, t.UIPadding / 1.6),
                        PaddingBottom = UDim.new(0, t.UIPadding / 1.6),
                    }),
                    c('Frame', {
                        Size = UDim2.new(1, (t.UIPadding / 1.6) * 2, 1, (t.UIPadding / 1.6) * 2),
                        Position = UDim2.new(0.5, 0, 0.5, 0),
                        AnchorPoint = Vector2.new(0.5, 0.5),
                        ThemeTag = {
                            BackgroundColor3 = 'Text',
                ...
                R.MouseEnter:Connect(function()
                    d(R.Frame, 0.1, {BackgroundTransparency = 1}):Play()
                end)
            ...
            function r.Update(U, V, W)
                ...
                if W or r.Transparency then
                    ...
                    S.Position = UDim2.new(0, 0, 1 - r.Transparency or W, 0)
        ...
        function n.New(aa, ab)
            ...
            local q = n:Colorpicker(o, function(q, r)
                if p then
                    o:Update(q, r)
            ...
            o:Update(o.Default, o.Transparency)
    ...
    function a.q()
        local aa, ab = game:GetService'UserInputService', a.load'c'
        local b, c, d = ab.New, ab.Tween, {
            Window = nil,
            WindUI = nil,
            Tabs = {},
            Containers = {},
        ...
        function d.New(e)
            ...
            d.TabCount = d.TabCount + 1

            local i = d.TabCount

            f.Index = i
            f.UIElements.Main = b('TextButton', {
                BackgroundTransparency = 1,
                Size = UDim2.new(1, 0, 0, 0),
                AutomaticSize = 'Y',
                Parent = e.Parent,
            ...
            if f.Icon and ab.Icon(f.Icon) then
                b('ImageLabel', {
                    ImageTransparency = 0.4,
                    Image = ab.Icon(f.Icon)[1],
                    ImageRectOffset = ab.Icon(f.Icon)[2].ImageRectPosition,
                    ImageRectSize = ab.Icon(f.Icon)[2].ImageRectSize,
                    Size = UDim2.new(0, 20, 0, 20),
                    LayoutOrder = 1,
                    ThemeTag = {
                        ImageColor3 = 'Text',
                ...
                f.UIElements.Main.TextLabel.Size = UDim2.new(1, -30, 0, 0)
                j = -30
            elseif f.Icon and string.find(f.Icon, 'rbxassetid://') then
                b('ImageLabel', {
                    ImageTransparency = 0.4,
                    Image = f.Icon,
                    Size = UDim2.new(0, 20, 0, 20),
            ...
            f.UIElements.ContainerFrame = b('ScrollingFrame', {
                Size = UDim2.new(1, -g.UIPadding, 1, 0),
                BackgroundTransparency = 1,
                ScrollBarThickness = 0,
                ElasticBehavior = 'Never',
                CanvasSize = UDim2.new(0, 0, 0, 0),
            ...
            f.UIElements.ContainerFrame.UIListLayout:GetPropertyChangedSignal'AbsoluteContentSize':Connect(function()
                f.UIElements.ContainerFrame.CanvasSize = UDim2.new(0, f.UIElements.ContainerFrame.UIListLayout.AbsoluteContentSize.X, 0, f.UIElements.ContainerFrame.UIListLayout.AbsoluteContentSize.Y + g.UIPadding * 2)
            end)

            local k, n = b('Frame', {
                Size = UDim2.new(0, 2, 1, 0),
                BackgroundTransparency = 1,
                Position = UDim2.new(1, -g.UIPadding / 3, 0, 0),
                AnchorPoint = Vector2.new(1, 0),
            }), b('Frame', {
            ...
            f.UIElements.ContainerFrameCanvas = b('Frame', {
                Size = UDim2.new(1, 0, 1, 0),
                BackgroundTransparency = 1,
                Visible = false,
                Parent = g.UIElements.MainBar,
            }, {
                f.UIElements.ContainerFrame,
                k,
            })
            d.Containers[i] = f.UIElements.ContainerFrameCanvas
            d.Tabs[i] = f

            f.UIElements.Main.MouseButton1Click:Connect(function()
                d:SelectTab(i)
            end)

            local p, q = function()
                local p = f.UIElements.ContainerFrame
                local q = math.clamp(p.AbsoluteWindowSize.Y / p.AbsoluteCanvasSize.Y, 0, 1)

                o.Size = UDim2.new(1, 0, q, 0)
                o.Visible = q < 1
            end, function()
                local p, q = o.Position.Y.Scale, math.max(f.UIElements.ContainerFrame.AbsoluteCanvasSize.Y - f.UIElements.ContainerFrame.AbsoluteWindowSize.Y, 1)

                f.UIElements.ContainerFrame.CanvasPosition = Vector2.new(0, p * q)
            end
            ...
            n.InputBegan:Connect(function(r)
                if r.UserInputType == Enum.UserInputType.MouseButton1 or r.UserInputType == Enum.UserInputType.Touch then
                    local s, t = (r.Position.Y - o.AbsolutePosition.Y)

                    t = aa.InputChanged:Connect(function(u)
                        if u.UserInputType == Enum.UserInputType.MouseMovement or u.UserInputType == Enum.UserInputType.Touch then
                            local v, w = k.AbsoluteSize.Y, k.AbsolutePosition.Y
                            local x = (u.Position.Y - w - s) / v

                            x = math.clamp(x, 0, 1)
                            o.Position = UDim2.new(0, 0, x, 0)
                    ...
                    u = aa.InputEnded:Connect(function(v)
            ...
            f.UIElements.ContainerFrame:GetPropertyChangedSignal'CanvasPosition':Connect(function()
                local r, s = f.UIElements.ContainerFrame.CanvasPosition.Y, f.UIElements.ContainerFrame.AbsoluteCanvasSize.Y - f.UIElements.ContainerFrame.AbsoluteWindowSize.Y
                local t = r / s

                o.Position = UDim2.new(0, 0, t, 0)
            end)
            o:GetPropertyChangedSignal'AbsoluteSize':Connect(function()
                k.Size = UDim2.new(0, k.Size.X.Offset, 1, -o.AbsoluteSize.Y - g.UIPadding / 2)
            end)
            f.UIElements.ContainerFrame:GetPropertyChangedSignal'AbsoluteCanvasSize':Connect(p)
            f.UIElements.ContainerFrame:GetPropertyChangedSignal'AbsoluteWindowSize':Connect(p)
            p()

            function f.Paragraph(r, s)
                local t = a.load'e'{
                    ...
                    Locked = s.Locked,
                    Parent = f.UIElements.ContainerFrame,
                    IsButtons = s.Buttons and #s.Buttons > 0 and true or false,
                    Theme = d.Window.Theme,
                    TextOffset = 0,
                    Window = g,
                    Hover = false,
                }

                if s.Buttons and #s.Buttons > 0 then
                    local u = b('Frame', {
                        Size = UDim2.new(1, 0, 0, 0),
                        BackgroundTransparency = 1,
                        Position = UDim2.new(0, 0, 0, s.Image and t.ImageSize > t.UIElements.Main.Title.AbsoluteSize.Y and t.ImageSize + t.UIPadding or t.UIElements.Main.Title.AbsoluteSize.Y + t.UIPadding),
                        AutomaticSize = 'Y',
                        Parent = t.UIElements.Main,
                    }, {
                        b('UIListLayout', {
                    ...
                    for v, w in next, s.Buttons do
                        local x = b('TextButton', {
                            Text = w.Title,
                            TextSize = 16,
                            AutomaticSize = 'Y',
                            ThemeTag = {
                            ...
                            Size = UDim2.new(1 / #s.Buttons, -(((#s.Buttons - 1) * 10) / #s.Buttons), 0, 32),
                            Parent = u,
                        }, {
                            b('UICorner', {
                                CornerRadius = UDim.new(0, 8),
                        ...
                        x.MouseEnter:Connect(function()
                            c(x, 0.1, {BackgroundTransparency = 0.3}):Play()
                        end)
                        x.MouseButton1Click:Connect(function()
                            c(x, 0.1, {BackgroundTransparency = 0.1}):Play()
                        end)
                        x.MouseButton1Click:Connect(function()
                            w.Callback()
                        end)
                ...
                f.Elements.Paragraph = t

                return t
            end
            function f.Button(r, s)
            ...
            task.spawn(function()
                local r = b('Frame', {
                    BackgroundTransparency = 1,
                    Size = UDim2.new(1, 0, 1, -g.UIElements.Main.Main.Topbar.AbsoluteSize.Y),
                    Parent = f.UIElements.ContainerFrame,
                }, {
                    b('UIListLayout', {
                        Padding = UDim.new(0, 8),
                    ...
                    b('TextLabel', {
                        ...
                        TextColor3 = Color3.fromHex(d.Window.Theme.Text),
                        ThemeTag = {
                            TextColor3 = 'Text',
                        },
                        TextSize = 18,
                ...
                f.UIElements.ContainerFrame.ChildAdded:Connect(function()
                    r.Visible = false
                end)
            end)
        ...
        function d.SelectTab(e, f)
            d.SelectedTab = f

            for g, h in next, d.Tabs do
                c(h.UIElements.Main.TextLabel, 0.15, {TextTransparency = 0.4}):Play()

                if h.Icon and ab.Icon(h.Icon) then
                    c(h.UIElements.Main.ImageLabel, 0.15, {ImageTransparency = 0.4}):Play()
                end

                h.Selected = false
            end

            c(d.Tabs[f].UIElements.Main.TextLabel, 0.15, {TextTransparency = 0}):Play()

            if d.Tabs[f].Icon and ab.Icon(d.Tabs[f].Icon) then
                c(d.Tabs[f].UIElements.Main.ImageLabel, 0.15, {ImageTransparency = 0}):Play()
            end

            d.Tabs[f].Selected = true

            task.spawn(function()
                for i, j in next, d.Containers do
                    j.AnchorPoint = Vector2.new(0, 0.05)
                    j.Visible = false
                end

                d.Containers[f].Visible = true

                c(d.Containers[f], 0.15, {
                    AnchorPoint = Vector2.new(0, 0),
                }, Enum.EasingStyle.Quart, Enum.EasingDirection.Out):Play()
            end)
        end
    ...
    function a.r()
        local aa, ab, b = game:GetService'UserInputService', game:GetService'RunService', a.load'c'
        ...
        return function(f)
            ...
            g.UIElements.SideBar = c('ScrollingFrame', {
                ...
                c('UIPadding', {
                    PaddingTop = UDim.new(0, g.UIPadding),
                    PaddingLeft = UDim.new(0, g.UIPadding + 4),
                    PaddingBottom = UDim.new(0, g.UIPadding),
                }),
                c('UIListLayout', {
                    SortOrder = 'LayoutOrder',
            ...
            g.UIElements.SideBarContainer = c('Frame', {
                Size = UDim2.new(0, g.SideBarWidth - g.UIPadding + 4, 1, -g.UIPadding * 4),
                Position = UDim2.new(0, 0, 0, g.UIPadding * 4),
                BackgroundTransparency = 1,
            }, {
            ...
            local q, r = function()
                local q = g.UIElements.SideBar
                local r = math.clamp(q.AbsoluteWindowSize.Y / q.AbsoluteCanvasSize.Y, 0, 1)

                p.Size = UDim2.new(1, 0, r, 0)
                p.Visible = r < 1
            end, function()
                local q, r = p.Position.Y.Scale, math.max(g.UIElements.SideBar.AbsoluteCanvasSize.Y - g.UIElements.SideBar.AbsoluteWindowSize.Y, 1)

                g.UIElements.SideBar.CanvasPosition = Vector2.new(0, q * r)
            end
            ...
            g.UIElements.SideBar:GetPropertyChangedSignal'CanvasPosition':Connect(function()
                local s, t = g.UIElements.SideBar.CanvasPosition.Y, g.UIElements.SideBar.AbsoluteCanvasSize.Y - g.UIElements.SideBar.AbsoluteWindowSize.Y
                local u = s / t

                p.Position = UDim2.new(0, 0, u, 0)
            end)
            p:GetPropertyChangedSignal'AbsoluteSize':Connect(function()
                n.Size = UDim2.new(0, n.Size.X.Offset, 1, -p.AbsoluteSize.Y - g.UIPadding / 2)
            end)
            g.UIElements.SideBar:GetPropertyChangedSignal'AbsoluteCanvasSize':Connect(q)
            g.UIElements.SideBar:GetPropertyChangedSignal'AbsoluteWindowSize':Connect(q)
            q()

            g.UIElements.MainBar = c('Frame', {
                Size = UDim2.new(1, -g.UIElements.SideBarContainer.AbsoluteSize.X, 1, -g.UIPadding * 4),
                Position = UDim2.new(0, g.UIElements.SideBarContainer.AbsoluteSize.X, 0, g.UIPadding * 4),
                BackgroundTransparency = 1,
            })

            local s, t, u, v, w, x = c('Frame', {
                Size = UDim2.new(1, 0, 1, 0),
                BackgroundTransparency = 1,
                ZIndex = 3,
                Name = 'Gradient',
                ...
                Image = b.Icon'square'[1],
                ImageRectOffset = b.Icon'square'[2].ImageRectPosition,
                ImageRectSize = b.Icon'square'[2].ImageRectSize,
                BackgroundTransparency = 1,
                Size = UDim2.new(1, -6, 1, -6),
                ThemeTag = {
                    ImageColor3 = 'Text',
                ...
                Image = b.Icon'minus'[1],
                ImageRectOffset = b.Icon'minus'[2].ImageRectPosition,
                ImageRectSize = b.Icon'minus'[2].ImageRectSize,
                BackgroundTransparency = 1,
                Size = UDim2.new(1, -6, 1, -6),
                ThemeTag = {
                    ImageColor3 = 'Text',
            ...
            if not x then
                ...
                z = c('TextButton', {
                    ...
                    c('ImageLabel', {
                        Image = b.Icon'grab'[1],
                        ImageRectOffset = b.Icon'grab'[2].ImageRectPosition,
                        ImageRectSize = b.Icon'grab'[2].ImageRectSize,
                        Size = UDim2.new(0, 20, 0, 20),
                        BackgroundTransparency = 1,
                        Position = UDim2.new(0, 0, 0.5, 0),
                        AnchorPoint = Vector2.new(0, 0.5),
                ...
                z.TextButton.MouseEnter:Connect(function()
                    d(z.UIScale, 0.1, {Scale = 0.99}):Play()
                end)
                z.TextButton.MouseLeave:Connect(function()
                    d(z.UIScale, 0.1, {Scale = 1.05}):Play()
                end)
            end
            ...
            if g.HasOutline then
                C = c('Frame', {
                    ...
                    Position = UDim2.new(0.5, 0, 1, g.UIPadding),
                    BackgroundTransparency = 1,
                    AnchorPoint = Vector2.new(0.5, 0.5),
                    ThemeTag = {
                ...
                D = c('Frame', {
                    Name = 'Outline',
                    Size = UDim2.new(0, 1, 1, -g.UIPadding * 4),
                    Position = UDim2.new(0, g.SideBarWidth, 0, g.UIPadding * 4),
                    BackgroundTransparency = 1,
            ...
            g.UIElements.Main = c('Frame', {
                ...
                c('CanvasGroup', {
                    ...
                    D,
                    c('Frame', {
                        Size = UDim2.new(1, 0, 0, g.UIPadding * 4),
                        BackgroundTransparency = 1,
                        Name = 'Topbar',
                    }, {
                        C,
                ...
                if g.Icon then
                    ...
                    elseif string.find(g.Icon, 'http') then
                        if not isfile('WindUI' .. g.Folder .. '/Assets/Icon.png') then
                            ...
                            writefile('WindUI' .. g.Folder .. '/Assets/Icon.png', I)
                        end

                        H.Image = getcustomasset('WindUI' .. g.Folder .. '/Assets/Icon.png')
                        A.Image = getcustomasset('WindUI' .. g.Folder .. '/Assets/Icon.png')
                    else
                        if b.Icon(tostring(g.Icon))[1] then
                            H.Image = b.Icon(g.Icon)[1]
                            H.ImageRectOffset = b.Icon(g.Icon)[2].ImageRectPosition
                            H.ImageRectSize = b.Icon(g.Icon)[2].ImageRectSize
            ...
            function g.Open(G)
                ...
                d(g.UIElements.Main.Background, 0.25, {
                    BackgroundTransparency = f.Transparent and 0.25 or 0,
                }, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
                d(g.UIElements.Main.Main, 0.25, {GroupTransparency = 0}, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
                d(g.UIElements.Main.UIScale, 0.25, {Scale = 1}, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
                d(s, 0.25, {BackgroundTransparency = 0}, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
                d(t, 0.25, {ImageTransparency = 0.7}, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
                d(i, 0.25, {Transparency = 0.8}, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
            ...
            function g.Close(G)
                ...
                d(g.UIElements.Main.Background, 0.25, {BackgroundTransparency = 1}, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
                d(g.UIElements.Main.Main, 0.25, {GroupTransparency = 1}, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
                d(g.UIElements.Main.UIScale, 0.25, {Scale = 0.9}, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
                d(s, 0.25, {BackgroundTransparency = 1}, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
                d(t, 0.25, {ImageTransparency = 1}, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
                d(i, 0.25, {Transparency = 1}, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out):Play()
                task.spawn(function()
                    task.wait(0.25)
            ...
            local G, H, I, J = b.Icon'copy', (b.Icon'square')

            v.MouseButton1Click:Connect(function()
                local K = g.IsFullscreen

                b.SetDraggable(K)

                if not K then
                    I = g.UIElements.Main.Position
                    J = g.UIElements.Main.Size
                    v.Image = G[1]
                    v.ImageRectOffset = G[2].ImageRectPosition
                    v.ImageRectSize = G[2].ImageRectSize
                else
                    v.Image = H[1]
                    v.ImageRectOffset = H[2].ImageRectPosition
                    v.ImageRectSize = H[2].ImageRectSize
                end

                d(g.UIElements.Main, 0.45, {
                    Size = K and J or UDim2.new(1, -20, 1, -20),
                }, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
                delay(0.1, function()
                    d(g.UIElements.Main, 0.45, {
                        Position = K and I or g.Position,
                    }, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
                end)

                g.IsFullscreen = not K
            end)
            w.MouseButton1Click:Connect(function()
                ...
                local K = x and 'Press ' .. g.ToggleKey.Name .. ' \u{6253}\u{5f00}ui' or '\u{5355}\u{51fb}\u{201c}\u{6253}\u{5f00}\u{201d}\u{6765}\u{91cd}\u{65b0}\u{663e}\u{793a}ui'

                if not e then
                    e = not e

                    f.WindUI:Notify{
                        Title = '\u{6700}\u{5c0f}\u{5316}',
                        Content = '\u{4f60}\u{628a}ui\u{6700}\u{5c0f}\u{5316}\u{4e86}\u{ff0c}\u{53ef}\u{901a}\u{8fc7}\u{201c}\u{6253}\u{5f00}\u{201d}\u{65c1}\u{7684}\u{56fe}\u{50cf}\u{8fdb}\u{884c}\u{62d6}\u{52a8}' .. K,
                        Icon = 'eye-off',
                        Duration = 5,
                    }
                end
            ...
            aa.InputBegan:Connect(function(K, L)
                if L then
                    return
                end
                if K.KeyCode == g.ToggleKey then
                    if g.Closed then
                        g:Open()
                    else
                        g:Close()
            ...
            function g.EditOpenButton(K, L)
                ...
                if z and z.Parent ~= nil then
                    local M = {
                        Title = L.Title or g.Title,
                        Icon = L.Icon or g.Icon,
                        OnlyMobile = L.OnlyMobile or true,
                        CornerRadius = L.CornerRadius or UDim.new(1, 0),
                        StrokeThickness = L.StrokeThickness or 2,
                        Color = L.Color or ColorSequence.new(Color3.fromHex'40c9ff', Color3.fromHex'e81cff'),
                    }

                    if M.OnlyMobile then
                        x = aa.KeyboardEnabled or not aa.TouchEnabled
                    else
                        x = false
                    end
                    ...
                    if b.Icon(M.Icon) and A then
                        A.Image = b.Icon(M.Icon)[1]
                        A.ImageRectOffset = b.Icon(M.Icon)[2].ImageRectPosition
                        A.ImageRectSize = b.Icon(M.Icon)[2].ImageRectSize
                    end

                    z.UIStroke.UIGradient.Color = M.Color

                    if B then
                        B.UIGradient.Color = M.Color
                    end

                    z.UICorner.CornerRadius = M.CornerRadius
                    z.UIStroke.Thickness = M.StrokeThickness
                end
            end

            local K = a.load'q'.Init(g, f.WindUI)

            function g.Tab(L, M)
                return K.New{
                    Title = M.Title,
                    Icon = M.Icon,
                    Parent = g.UIElements.SideBar,
                }
            end
            function g.SelectTab(L, M)
                K:SelectTab(M)
            end
            function g.Divider(L)
                local M = c('Frame', {
            ...
            local L = a.load'n'.Init(g)

            function g.Dialog(M, N)
                local O, P = {
                ...
                P.UIElements.UIListLayout = c('UIListLayout', {
                ...
                P.UIElements.Title = c('TextLabel', {
                    Text = O.Title,
                    TextSize = 20,
                    FontFace = Font.new(b.Font, Enum.FontWeight.SemiBold),
                    TextXAlignment = 'Left',
                ...
                c('Frame', {
                    Name = 'Line',
                    Size = UDim2.new(1, P.UIPadding * 2, 0, 1),
                    Parent = P.UIElements.Main,
                    LayoutOrder = 3,
                    BackgroundTransparency = 1,
                    ThemeTag = {
                ...
                for R, S in next, O.Buttons do
                    local T = c('TextButton', {
                        ...
                        c('UIPadding', {
                            PaddingTop = UDim.new(0, P.UIPadding / 1.85),
                            PaddingLeft = UDim.new(0, P.UIPadding / 1.85),
            ...
            local N = function(N)
                if not isFullscreen then
                    ...
                    d(k, 0.2, {BackgroundTransparency = 0.65}):Play()
                    d(k.ImageLabel, 0.2, {ImageTransparency = 0}):Play()
                    N.Changed:Connect(function()
                        if N.UserInputState == Enum.UserInputState.End then
                            isResizing = false
                            k.Active = false

                            d(k, 0.2, {BackgroundTransparency = 1}):Play()
                            d(k.ImageLabel, 0.2, {ImageTransparency = 1}):Play()
                        end
                    end)
                end
            end
            ...
            aa.InputChanged:Connect(function(O)
                if isResizing then
                    if O.UserInputType == Enum.UserInputType.MouseMovement or O.UserInputType == Enum.UserInputType.Touch then
                        ...
                        d(g.UIElements.Main, 0.06, {
                            Size = UDim2.new(0, math.clamp(Q.X.Offset, 480, 700), 0, math.clamp(Q.Y.Offset, 350, 520)),
                        }):Play()
                    end
                end
            end)
...
aa.ScreenGui = d('ScreenGui', {
    Name = 'WindUI',
    Parent = ab:IsStudio() and f.PlayerGui or game:GetService'CoreGui',
    IgnoreGuiInset = true,
}, {
    d('Folder', {
        Name = 'Window',
...
local h = a.load'd'
local i = h.Init(aa.ScreenGui.Notifications)
...
function aa.CreateWindow(j, k)
    ...
    if aa.Window then
        warn'\u{60a8}\u{4e0d}\u{80fd}\u{521b}\u{5efa}\u{591a}\u{4e2a}\u{7a97}\u{53e3}'

        return
    end

    local o, p = true, b[k.Theme or 'Dark']

    aa.Theme = p

    c.SetTheme(p)

    local q = f.Name or 'Random'

    function KeySystem()
        o = false

        local r = a.load'n'.Init(aa.ScreenGui.KeySystem)
        local s = r.Create(true)

        s.UIElements.Main.AutomaticSize = 'XY'

        local t = d('ImageLabel', {
            Image = 'rbxassetid://8992230677',
            ImageColor3 = Color3.new(0, 0, 0),
        ...
        local w, x, y = d('TextLabel', {
            Text = '\u{5361}\u{5bc6}\u{7cfb}\u{7edf}',
            TextSize = 20,
        ...
        if k.KeySystem.SaveKey and k.Folder then
            d('TextLabel', {
                Text = '\u{4f60}\u{7684}\u{5361}\u{5bc6}\u{5c06}\u{4f1a}\u{81ea}\u{52a8}\u{4fdd}\u{5b58}\u{5230}\u{672c}\u{5730}Workspace/' .. k.Folder .. '/' .. q .. '.key',
                TextSize = 13,
                FontFace = Font.new(c.Font, Enum.FontWeight.SemiBold),
                TextXAlignment = 'Left',
                TextWrapped = false,
        ...
        A.MouseButton1Click:Connect(function()
            ...
            if C and C == k.KeySystem.Key then
                s:Close()()
                e(t, 0.1, {ImageTransparency = 1}):Play()

                o = true

                if k.KeySystem.SaveKey and k.Folder then
                    writefile(k.Folder .. '/' .. q .. '.key', tostring(C))
                end
        ...
        if k.KeySystem.URL then
            ...
            B.MouseButton1Click:Connect(function()
                ...
                B.Text = '\u{83b7}\u{5f97}\u{5361}\u{5bc6}'
            end)
        end
    ...
    if k.KeySystem then
        if k.KeySystem.SaveKey and k.Folder then
            if isfile(k.Folder .. '/' .. q .. '.key') and k.KeySystem.Key == readfile(k.Folder .. '/' .. q .. '.key') then
                o = true
            else
                KeySystem()
            end
    ...
    local r = n{
        ...
        Icon = k.Icon,
        Folder = k.Folder,
        HasOutline = k.HasOutline,
        Theme = p,
        WindUI = aa,
        Parent = aa.ScreenGui.Window,
    ...
    function r.ToggleTransparency(s, t)
        aa.Transparent = t
        r.UIElements.Main.Background.BackgroundTransparency = t and aa.TransparencyValue or 0
